...
//                sqlite.statement(SQLStatements.PROBABILITY_FIND_FLAKY_NO_ORIGINAL)));
        ...
        // System.out.println(command("numFlakyTestRandClassMethod",
        //    String.valueOf(numODTestRandClassMethod + numNOTestRandClassMethod)));
        ...
        // System.out.println(command("numFlakyTestReverseClass",
        //     String.valueOf(numODTestReverseClass + numNOTestReverseClass)));
    ...
    private String commandQuery(final String commandName, final String postStr, final Procedure procedure)
            throws SQLException {
